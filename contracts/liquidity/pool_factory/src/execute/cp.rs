...
///   2. builds the outbound `RouterReceiveMsg::RequestPoolCreation`
...
///   3. builds the outbound `RouterReceiveMsg::AddLiquidity` via
...
///      (sender, tx_id),
///   3. builds the outbound `RouterReceiveMsg::RemoveLiquidity`
    ...
    fn test_on_request_pool_creation_happy_path_sets_reply_data() {
        ...
        match reply {
            euclid::msgs::pool_factory::PoolFactoryReply::SendPacket {
                ...
                assert!(matches!(
                    router_msg,
                    euclid_ibc::wire::envelope::router::RouterReceiveMsg::RequestPoolCreation(
    ...
    fn test_on_add_liquidity_happy_path_sets_reply_data() {
        ...
        match reply {
            euclid::msgs::pool_factory::PoolFactoryReply::SendPacket {
                ...
                assert!(matches!(
                    router_msg,
                    euclid_ibc::wire::envelope::router::RouterReceiveMsg::AddLiquidity(
                        AddLiquiditySendMsg { .. }
                    )
                ));
    ...
    fn test_on_remove_liquidity_happy_path_sets_reply_data() {
        ...
        match reply {
            euclid::msgs::pool_factory::PoolFactoryReply::SendPacket {
                ...
                assert!(matches!(
                    router_msg,
                    euclid_ibc::wire::envelope::router::RouterReceiveMsg::RemoveLiquidity(_)
                ));
