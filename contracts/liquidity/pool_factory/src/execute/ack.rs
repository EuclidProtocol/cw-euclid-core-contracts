...
pub fn on_pool_ack(
    ...
    let msg: RouterReceiveMsg = from_json(&original_msg)?;
    match msg {
...
mod tests {
    ...
    use euclid_ibc::wire::msgs::AddLiquiditySendMsg;
    use euclid_ibc::wire::msgs::RemoveLiquiditySendMsg;
    ...
    fn add_liquidity_original_msg(sender_addr: &str, tx_id: &str) -> Binary {
        to_json_binary(&RouterReceiveMsg::AddLiquidity(AddLiquiditySendMsg {
    ...
    fn remove_liquidity_original_msg(sender_addr: &str, tx_id: &str) -> Binary {
        to_json_binary(&RouterReceiveMsg::RemoveLiquidity(RemoveLiquiditySendMsg {
            sender: CrossChainUser {
                chain_uid: euclid::chain::ChainUid::create("testchain".to_string()).unwrap(),
                address: sender_addr.to_string(),
            },
    ...
    fn concentrated_pool_creation_original_msg(sender_addr: &str, tx_id: &str) -> Binary {
        to_json_binary(&RouterReceiveMsg::RequestConcentratedPoolCreation(
