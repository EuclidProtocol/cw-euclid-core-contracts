...
use crate::{
    ...
    state::{
        ADMIN, FEE_STATE, OWNER_POSITION_SET, PAIR_TO_VLP, PENDING_ADD_LIQUIDITY,
        ...
        PENDING_DEPOSIT_TOKEN, PENDING_NFT_MINT_POSITION, PENDING_POOL_REQUESTS,
        ...
        AcknowledgementMsg::Ok(data) => {
            ...
            match existing_meta {
                ...
                None => {
                    ...
                    PENDING_NFT_MINT_POSITION.save(deps.storage, &(sender.clone(), position_id))?;
                    res = res.add_submessage(SubMsg::reply_always(mint_msg, NFT_MINT_REPLY_ID));
                }
            }
