...
use euclid::{
    error::ContractError,
    msgs::vlp::stable::msg::MigrateMsg,
...
mod tests {
    ...
    fn mock_querier_with_metadata_and_balances(
        decimals_1: u32,
        decimals_2: u32,
        balance_1: Uint256,
        balance_2: Uint256,
    ...
    fn make_deps(
        ...
        MockQuerier,
    > {
        let querier = mock_querier_with_metadata_and_balances(
            decimals_1,
            decimals_2,
            vb_balance_1,
            vb_balance_2,
    ...
    #[test]
    fn test_migrate_normalizes_reserves_and_verifies_voucher_balance() {
