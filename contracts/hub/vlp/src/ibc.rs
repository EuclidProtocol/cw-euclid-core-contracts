...
pub fn do_ibc_packet_receive(
    ...
    match msg {
        ...
        IbcExecuteMsg::Swap { chain_id, asset, asset_amount, min_amount_out, channel: _, swap_id, pool_address } => execute::execute_swap(deps, chain_id, asset, asset_amount, min_amount_out, swap_id),
