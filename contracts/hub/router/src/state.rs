...
use euclid_ibc::wire::msgs::{
    CollectConcentratedFeesSendMsg, CollectConcentratedProtocolFeesSendMsg,
    RemoveConcentratedLiquiditySendMsg, RemoveLiquiditySendMsg, SingleSidedAddLiquiditySendMsg,
    SwapSendMsg,
};
...
pub const PENDING_SWAPS: Map<String, SwapSendMsg> = Map::new("pending_swaps");

// Tx Id to Remove Liquidity Request
pub const PENDING_REMOVE_LIQUIDITY: Map<String, RemoveLiquiditySendMsg> =
    Map::new("pending_remove_liquidity");
pub const PENDING_CONCENTRATED_REMOVE_LIQUIDITY: Map<String, RemoveConcentratedLiquiditySendMsg> =
    Map::new("pending_concentrated_remove_liquidity");
pub const PENDING_CONCENTRATED_COLLECT_FEES: Map<String, CollectConcentratedFeesSendMsg> =
...
pub const PENDING_SINGLE_SIDED_LIQUIDITY: Map<String, SingleSidedAddLiquiditySendMsg> =
