...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/swap.rs::swap_concentrated_succeeds_on_all — EVM + Cosmos
#[rstest]
...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/parity.rs::clp_larger_swap_has_worse_effective_price
#[rstest]
#[case(FactorySetupMode::Native, FACTORY_CHAIN_ID_LOCAL)]
#[case(FactorySetupMode::Ibc, FACTORY_CHAIN_ID_IBC)]
...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/parity.rs::clp_round_trip_loses_value
#[rstest]
#[case(FactorySetupMode::Native, FACTORY_CHAIN_ID_LOCAL)]
#[case(FactorySetupMode::Ibc, FACTORY_CHAIN_ID_IBC)]
