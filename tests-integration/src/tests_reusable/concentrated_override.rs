...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/overrides.rs::clp_euclid_fee_override_waives_protocol_cut_and_matches_execution — EVM + Cosmos
#[rstest]
