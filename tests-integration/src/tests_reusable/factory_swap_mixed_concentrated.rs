...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/mixed_routes.rs::mixed_engine_route_executes_on_all — EVM + Cosmos
#[rstest]
...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/mixed_routes.rs::mixed_route_simulation_matches_execution
#[rstest]
#[case(FactorySetupMode::Native, FACTORY_CHAIN_ID_LOCAL)]
#[case(FactorySetupMode::Ibc, FACTORY_CHAIN_ID_IBC)]
...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/mixed_routes.rs::clp_hop_with_mismatched_pool_key_rejected
#[rstest]
#[case(FactorySetupMode::Native, FACTORY_CHAIN_ID_LOCAL)]
#[case(FactorySetupMode::Ibc, FACTORY_CHAIN_ID_IBC)]
