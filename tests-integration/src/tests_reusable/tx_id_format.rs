...
mod tests {
    ...
    use crate::helpers::relayer::{
        decode_router_receive_msg, extract_send_packet_events, relay_factory_ack_packet,
    ...
    fn register_and_capture_tx_id(
        ...
        let msg = decode_router_receive_msg(&packet);
    ...
    // Cross-VM coverage: testing/euclid-tests/tests/protocol/failures.rs::pending_packet_count_and_tx_id_shape
    #[test]
    ...
    // Cross-VM coverage: testing/euclid-tests/tests/protocol/failures.rs::tx_nonce_increments_across_calls
    #[test]
