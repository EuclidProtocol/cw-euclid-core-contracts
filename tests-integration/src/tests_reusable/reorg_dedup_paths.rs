...
mod tests {
    ...
    // Cross-VM coverage:
    //   testing/euclid-tests/tests/protocol/failures.rs::duplicate_packet_delivery_rejected
    //   testing/euclid-tests/tests/security/replay.rs::replay_receive_packet_on_router_is_rejected
    #[test]
    ...
    // Cross-VM coverage: testing/euclid-tests/tests/protocol/failures.rs::duplicate_ack_delivery_rejected
    #[test]
