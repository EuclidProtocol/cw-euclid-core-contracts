...
mod tests {
    ...
    // Cross-VM coverage: testing/euclid-tests/tests/protocol/single_sided_liquidity/add_liquidity.rs::single_sided_liquidity_succeeds_on_all — EVM + Cosmos
    ...
    // Cross-VM coverage: testing/euclid-tests/tests/protocol/single_sided_liquidity/add_liquidity.rs::single_sided_liquidity_min_lp_out_error_ack_settles
    #[cfg_attr(not(feature = "full_decimals"), apply(decimal_pair))]
    #[cfg_attr(feature = "full_decimals", apply(decimal_pair_full))]
    fn test_single_sided_ack_failure_refunds_user(
        ...
        match result {
            Ok(events) => {
                ...
                let ack_str = first_ack.ack.clone();
