...
mod tests {
    ...
    // Cross-VM coverage:
    //   testing/euclid-tests/tests/protocol/swap.rs::swap_succeeds_on_all — EVM + Cosmos
    //   testing/euclid-tests/tests/protocol/swap.rs::multi_hop_swap_succeeds_on_all — EVM + Cosmos
