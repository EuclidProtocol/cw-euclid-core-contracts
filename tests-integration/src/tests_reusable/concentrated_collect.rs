...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/fees.rs::clp_protocol_fee_collect_native_admin_succeeds
#[rstest]
#[case(FactorySetupMode::Native, FACTORY_CHAIN_ID_LOCAL)]
#[case(FactorySetupMode::Ibc, FACTORY_CHAIN_ID_IBC)]
...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/authorization.rs::clp_non_owner_cannot_collect
#[rstest]
#[case(FactorySetupMode::Native, FACTORY_CHAIN_ID_LOCAL)]
#[case(FactorySetupMode::Ibc, FACTORY_CHAIN_ID_IBC)]
...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/fees.rs::clp_protocol_fee_collect_unauthorized_rejected
#[rstest]
#[case(FactorySetupMode::Native, FACTORY_CHAIN_ID_LOCAL)]
#[case(FactorySetupMode::Ibc, FACTORY_CHAIN_ID_IBC)]
...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/authorization.rs::clp_nonexistent_position_rejected
#[test]
...
// Cross-VM coverage: testing/euclid-tests/tests/protocol/concentrated/fees.rs::clp_full_remove_auto_collects_pending_fees
#[rstest]
#[case(FactorySetupMode::Native, FACTORY_CHAIN_ID_LOCAL)]
