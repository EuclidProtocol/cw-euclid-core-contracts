...
mod tests {
    ...
    // Cross-VM coverage: testing/euclid-tests/tests/protocol/create_pool.rs::create_pool_without_denom_errors
    #[rstest]
    #[case::stable(PoolConfig::Stable { amp_factor: Some(Uint64::new(100)) }, FACTORY_CHAIN_ID_LOCAL)]
    #[case::constant_product(PoolConfig::ConstantProduct {}, FACTORY_CHAIN_ID_LOCAL)]
    #[case::stable(PoolConfig::Stable { amp_factor: Some(Uint64::new(100)) }, FACTORY_CHAIN_ID_IBC)]
    ...
    // Cross-VM coverage:
    //   testing/euclid-tests/tests/protocol/create_pool.rs::create_pool_succeeds
    //   testing/euclid-tests/tests/protocol/create_pool.rs::create_pool_succeeds_on_all — EVM + Cosmos
