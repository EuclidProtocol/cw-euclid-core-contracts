...
mod tests {
    ...
    // Cross-VM coverage: testing/euclid-tests/tests/protocol/voucher.rs::voucher_deposit_withdraw_roundtrip
    #[apply(factory_modes)]
    ...
    // Cross-VM coverage: testing/euclid-tests/tests/protocol/voucher.rs::voucher_withdraw_dust_moves_no_value
    #[apply(factory_modes)]
