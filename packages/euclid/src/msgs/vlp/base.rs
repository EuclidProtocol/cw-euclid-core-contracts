...
#[cfg_attr(feature = "cross-vm", cross_vm(trait_name = "VlpBaseQueryFns"))]
pub enum QueryMsg {
    #[cfg_attr(feature = "cross-vm", returns(GetLiquidityQueryResponse))]
    Liquidity {},
    #[cfg_attr(feature = "cross-vm", returns(GetSwapQueryResponse))]
    SimulateSwap(VlpSimulateSwapMsg),
}

#[cw_serde]
#[cfg_attr(feature = "cross-vm", derive(cross_vm_macros::CwExecuteFns))]
#[cfg_attr(feature = "cross-vm", cross_vm(trait_name = "VlpBaseExecuteFns"))]
pub enum ExecuteMsg {
...
mod tests {
    ...
    fn pool_key_parse_rejects_malformed_keys() {
        let cases: Vec<(&str, &str)> = vec![
            ("", "empty string"),
            ("a\x00b", "only two parts"),
            ("a\x00b\x00500", "only three parts"),
            ("a\x00b\x00500\x0010\x00extra", "five parts"),
            ("a\x00b\x00notnum\x0010", "non-numeric fee"),
            ("a\x00b\x00500\x00notnum", "non-numeric spacing"),
        ];
